...
//
// Notification config, keys is case-sensitive!
...
def notifyComponentOwner = ['Jira Service Desk']
...
def postSlackMsg(toChannel, msg, attach ='') {
    logger.info("Slack message to [$toChannel]: '${msg.take(80)}...' "+
...
// Get request issue type and type if exists, components and owners
